...
void tx_data()
{
    ...
    TXB0SIDL=DL;
    TXB0DLC=0X01;
    TXB0D0=CAN_READ_MESSAGE[0] ;
    TXB0D1=CAN_READ_MESSAGE[1];
    TXB0D2=CAN_READ_MESSAGE[2];
    TXB0D3=CAN_READ_MESSAGE[3];
    TXB0D4=CAN_READ_MESSAGE[4];
    TXB0D5=CAN_READ_MESSAGE[5];
    TXB0D6=CAN_READ_MESSAGE[6];
    TXB0D7=CAN_READ_MESSAGE[7];
    TXB0CON=0X08;
    CANCON=0X08;
